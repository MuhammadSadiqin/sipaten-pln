<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            ...
            <tr>
                <th colspan="5">
                    <a class="btn btn-warning float-end" href="{{ route('amr.export') }}"><button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4  rounded">Export TO Lbkb </button></a>
                </th>
            </tr>
            </div>
                ...
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        ...
                        <td class="border px-6 py-4 text-center">
                            <a href="{{ route('lbkb.edit',$item->id) }}" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mx-2 rounded">
                                Edit
                            </a>
                            <form action="{{ route('lbkb.destroy',$item->id) }}" method="POST" class="inline-block">
