        ...
        <div class="max-w-8xl mx-auto sm:px-7 lg:px-8">
            <div class="mb-10">
                ...
                <div class="mb-4 flex justify-end">
                    <form action="{{ route('amr.index') }}" method="GET">
                ...
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        ...
                        <td class="border px-6 py-4 text-center">
                            <a href="{{ route('amr.edit',$item->id) }}" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mx-2 rounded">
                                Edit
                            </a>
                            <form action="{{ route('amr.destroy',$item->id) }}" method="POST" class="inline-block">
